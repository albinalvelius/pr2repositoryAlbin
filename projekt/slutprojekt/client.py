...
def myProfile():
    ...
    for i in range(len(clients)-1):
        ...
        clientLabel[i].place(anchor=tk.NW, x=780, y=180 + 30*i)
    ...
    editclientb.place(anchor=tk.NW, x=640, y=130)

    c.pack()

def mainmenu():
    title = tk.Label(c, text=f'Välkommen {clients[1]} {clients[2]}', bg="white")
